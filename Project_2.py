...
page = st.sidebar.selectbox("Choose any one", ["Home","Parkinson's Prediction", "Liver Disease Prediction","Kidney Disease Prediction"])
...
def kidney_input():
# App Title
    st.header("🩺Kidney Disease Prediction App")
...
# Function to get user input
    ...
    with col4:
        ...
        wc = st.number_input("WBC Count (cells/cumm)", min_value=0, max_value=20000, value=8000)
        rc = st.number_input("RBC Count (millions/cmm)", min_value=0.0, max_value=10.0, step=0.1, value=5.0)
...
if page == "Home" :
    ...
    """
    ## About the App
    This Disease Prediction App is designed to assist individuals in predicting the likelihood of specific diseases 
    based on clinical data and symptoms. With the help of advanced machine learning models, the app provides 
    predictions for the following conditions:
    
    - **Parkinson's Disease**
    - **Kidney Disease**
    - **Liver Disease**
    
    Please note that this app is not a substitute for professional medical advice, diagnosis, or treatment. 
    ...
    """
    ## How It Works
    1. **Select a Disease:** Use the sidebar to choose the disease you want to predict.
    2. **Enter Your Data:** Provide the required clinical or personal health information.
    3. **Get Your Prediction:** Click the "Predict" button to get the prediction result and probability score.
    """
    )
